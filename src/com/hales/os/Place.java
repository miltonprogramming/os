...
/**
 * Created by chales on 4/23/2017.
 */
public class Place {

        String geom,icon,id,name,openhours,photos,place_id, price_leve,raiting, reference,scope,types;
    ...
    public Place(String g,String zero,String one,String two , String three, String four,String five, String six, String seven, String eight, String nine,String ten,double la,double lo)
    {
        geom=g;
        icon= zero;
        id=one;
