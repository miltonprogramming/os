...
public class Plumber extends Place{
    ...
    public Plumber(String vraiting,String geomv, String iconv, String idv, String namev, String place_idv, String reverencev, String scopev, String typesv,String vicinityv, double la, double lo) {
        super();
        geom = geomv;
        icon = iconv;
        id = idv;
